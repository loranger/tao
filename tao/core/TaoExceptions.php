...
class TaoExceptions
{
	...
	static function handle()
	{
		...
		set_exception_handler(array('TaoExceptions', "getException"));
		set_error_handler(array('TaoExceptions', "getError"), E_ALL);
	}
	 ...
	 **/
	static function getException($exception)
	{
		if(!headers_sent())
		{
	 ...
	 **/
	static function isError($exception)
	{
	 ...
	 * @param object exception
	 **/
	static function getErrorString($errorException)
	{
	 ...
	 * @param Exception $exception
	 **/
	static function getBacktrace($exception)
	{
